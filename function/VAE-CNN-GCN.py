...
k = 10
real_features = [compute_spectral_features(matrix, k=k) for matrix in real_matrices_norm]
real_features = np.array(real_features)

generated_features = [compute_spectral_features(matrix, k=k) for matrix in generated_matrices_norm]
...
fid_value_spec = calculate_fid(mu_real, sigma_real, mu_gen, sigma_gen)
print('FID spec value:', fid_value_spec)
